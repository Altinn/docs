...
- Man kan enkelt gjøre alt selv (inkl. prodsetting) når man ønsker det, uten behov for bestillinger, kursing, venting, etc. Flaskehalser elimineres.
...
- Datamodellering innebygd i det samme web-baserte verktøyet
- Ikke nødvendig med Citrix for tilgang
...
- Git (versjonskontroll) benyttes for lagring av tjenestene som utvikles, både fra nettleser og kode-verktøy.
