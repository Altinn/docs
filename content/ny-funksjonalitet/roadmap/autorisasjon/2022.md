...
### Oppslagspunkt (API) for ikke-offentlige virksomheter  
I dag tilbyr Altinn API for offentlig virksomheter hvor de kan gjøre oppslag på hvilke representasjonsforhold som finnes. En stor del av antatt samfunnsnytten for er fullmaktsløsning for innbyggere kommer av at vi gjør det enklere for næringsdrivende å digitalisere sine tjenester slik at de effektiviserer egen drift. Et tilsvarende API for private virksomheter og frivillig sektor finnes ikke.    

For å sikre disse gevinstene må det utvikles autorisasjons-API for denne brukergruppen samt en samtykkeløsning hvor bruker samtykker at applikasjon fra privat aktør (næringsdrivende eller frivillig sektor) gjør oppslag på mine vegne. Per nå ser vi for oss å utvikle denne løsningen i samarbeid med IDporten og Maskinporten
