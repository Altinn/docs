...
### Tilby tilgangsstrying på app-nivå for tjeneste 3.0 - gjenstående arbeid (2022)
Altinn Autorisasjon skal utvikle støtte for tilgangsstyring og autorisering av applikasjoner i Tjenester 3.0. Dette inkluderer autorisering på operasjonsnivå (f eks les, skriv, signer) og skal støtte applikasjoner med egne

### Begrense OIDC/OAuth2 tilgang via IDporten til angitte aktører (2022)
...
### Gjøre det mulig å endre rollekrav på en tjeneste som er satt i produksjon uten at bruker må delegere på nytt
