...
Før man kan teste må punktene under [Komme i gang](/docs/guides/samtykke/datakonsument/komme_i_gang/#før-man-kan-ta-i-bruk-tjenesten-må-følgende-være-på-plass) være på plass.
...
Nærmere beskrivelse av parametre i url finner [her.] (/docs/guides/samtykke/datakonsument/be_om_samtykke/#url)
...
Autorisasjonskoden benyttes til å hente token signert av Altinn. Se [Informasjon om token.] (docs/guides/samtykke/tjenesteeier_datakilde/bruk_av_token/#bruk-av-self-contained-oauth-token)
...
{{< figure src="/docs/images/guides/samtykke/figur14.jpg" title="Hente token ved hjelp av Postman" >}}
