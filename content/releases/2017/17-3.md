---
title: 17.3
description: Søk på tvers, soft due date, gi fullmakt, ...
weight: 100
---
...
- [Autorisasjon](#autorisasjon)
  - [Deleger enkeltrettigheter skal gjelde for alle versjoner av et element](#deleger-enkeltrettigheter-skal-gjelde-for-alle-versjoner-av-et-element)
...
## Tjenesteeiersarkiv
- [Endre uthenting av avgiver fra Tjenesteeiersarkiv slik at den velger riktig arkiv](#Endre-uthenting-av-avgiver-fra-Tjenesteeiersarkiv-slik-at-den-velger-riktig-arkiv)


## Små feilrettinger som kommer 17.3
- [Diverse bugfix i 17.3](#Diverse_bugfix_i_17.3)
...
{{<figure src="/docs/images/releases/2017/17-3/søk-alle-jeg-kan-representere.png?width=400" title="Du kan velge \"Alle jeg kan representere\" for å søke på tvers av alle..." >}}
...
### Deleger enkeltrettigheter skal gjelde for alle versjoner av et element
